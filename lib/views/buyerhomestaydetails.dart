        ...
        Card(
          ...
          child: Container(
              child: CachedNetworkImage(
                fit: BoxFit.cover,
                imageUrl:"${ServerConfig.server}/homestayfinal/assets/homestayimages/${widget.homestay.homestayId}.png",
              ...
              children: [
                ...
                TableRow(children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text('Bedrooms', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold))
                      ]),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${widget.homestay.bedroomQty}",
                            style: const TextStyle(fontSize: 20.0))
                      ]),
                ]),
                TableRow(children: [
